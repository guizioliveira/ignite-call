...
-- AddForeignKey
ALTER TABLE `user_time_intevals` ADD CONSTRAINT `user_time_intevals_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
